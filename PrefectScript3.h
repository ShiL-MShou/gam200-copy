...
class PrefectScript3 : public NPCScript
{
	bool isRight;
	bool isUp;
...
public:
	...
	// delete
	PrefectScript3(const PrefectScript3&) = delete;
	PrefectScript3& operator=(const PrefectScript3&) = delete;
