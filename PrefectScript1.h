...
class PrefectScript1 : public NPCScript
{
	bool isRight;
	bool isUp;
	...
	std::shared_ptr<GiveUpChasing> stop1 = std::make_shared<GiveUpChasing>(Patrol);
	std::shared_ptr<GiveUpChasing> stop2 = std::make_shared<GiveUpChasing>(Idle);
...
public:
	...
	// delete
	PrefectScript1(const PrefectScript1&) = delete;
	PrefectScript1& operator=(const PrefectScript1&) = delete;
