...
class PrefectScript6 : public NPCScript
{
	bool isRight;
	bool isUp;
...
public:
	...
	// delete
	PrefectScript6(const PrefectScript6&) = delete;
	PrefectScript6& operator=(const PrefectScript6&) = delete;
