...
class PrefectScript2 : public NPCScript
{
	//bool isRight;
	//bool isUp;
...
public:
	...
	// delete
	PrefectScript2(const PrefectScript2&) = delete;
	PrefectScript2& operator=(const PrefectScript2&) = delete;
