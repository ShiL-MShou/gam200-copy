...
class PrefectScript5 : public NPCScript
{
	bool isRight;
	bool isUp;
...
public:
	...
	// delete
	PrefectScript5(const PrefectScript5&) = delete;
	PrefectScript5& operator=(const PrefectScript5&) = delete;
