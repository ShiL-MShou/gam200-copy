...
class PrefectScript4 : public NPCScript
{
	bool isRight;
	bool isUp;
...
public:
	...
	// delete
	PrefectScript4(const PrefectScript4&) = delete;
	PrefectScript4& operator=(const PrefectScript4&) = delete;
